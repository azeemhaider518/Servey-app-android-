...
public class EmrgFormOne extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFusedLocationProviderClient = LocationServices.getFusedLocationProviderClient(EmrgFormOne.this);
                ...
                location.addOnCompleteListener(new OnCompleteListener() {
                    ...
                    public void onComplete(@NonNull Task task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            if (validateInternet()) {
//                                Toast.makeText(EmrgFormOne.this, " Latitude: " + lat + " Longitude: " + lon, Toast.LENGTH_LONG).show();
                                DatabaseSyncEFOne worker = new DatabaseSyncEFOne(EmrgFormOne.this);
...
//                            Toast.makeText(EmrgFormOne.this, "unable to get current location", Toast.LENGTH_SHORT).show();
                        }
                        //currentLocation = (Location) task.getResult();
                        sharedPreferences.edit().putString("EmrgFormOne", sharedPreferences.getString("ID","") + ans1 + ans2 + ans3 + currentDateandTime + lat + "" + lon + "").apply();
                    }
                });

//                Toast.makeText(EmrgFormOne.this, "Done", Toast.LENGTH_LONG).show();
                finish();
    ...
    public static class FragmentOne extends Fragment implements View.OnClickListener {
        ...
        public void setUserVisibleHint(boolean isVisibleToUser) {
            ...
            if (this.isVisible()) {
                if (mButton1 != null && mButton2 != null && mButton3 != null && mButton4 != null) {
                    if (mButton1.getId() == q1BtnId) {
                        mButton1.setSelected(true);
                    } else if (mButton2.getId() == q1BtnId) {
                        mButton2.setSelected(true);
                    }else if (mButton3.getId() == q1BtnId) {
                        mButton3.setSelected(true);
                    }else if (mButton4.getId() == q1BtnId) {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            v = inflater.inflate(R.layout.emrg_form_one_q1, container, false);
...
//                input.setFilters(new InputFilter[]{ new RemoveBlankFilter().filter});
    ...
    public static class FragmentTwo extends Fragment implements View.OnClickListener {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                                 Bundle savedInstanceState) {
            v = inflater.inflate(R.layout.emrg_form_one_q2, container, false);
            mButton1 = v.findViewById(R.id.btn1);
            mButton2 = v.findViewById(R.id.btn2);
            mButton3 = v.findViewById(R.id.btn3);
            mButton4 = v.findViewById(R.id.btn4);
...
//                input.setFilters(new InputFilter[]{ new RemoveBlankFilter().filter});
    ...
    public static class FragmentThree extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                                 Bundle savedInstanceState) {
            View v = inflater.inflate(R.layout.emrg_form_one_q3, container, false);
