...
//                            Toast.makeText(FormOne.this, "unable to get current location", Toast.LENGTH_SHORT).show();
                        ...
                        currentLocation = (Location) task.getResult();
                        sharedPreferences.edit().putString("FormOne", sharedPreferences.getString("ID", "") + ans1 + ans2 + ans3 + ans4 + ans5 + currentDateandTime + currentLocation.getLongitude() + "" + currentLocation.getLongitude() + "").apply();
                    }
                });
