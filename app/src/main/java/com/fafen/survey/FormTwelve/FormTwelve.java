            ...
            public void onClick(View v)
            {
                ...
                location.addOnCompleteListener(new OnCompleteListener()
                {
                    ...
                    public void onComplete(@NonNull Task task)
                    {
                        ...
                        currentLocation = (Location) task.getResult();
                        sharedPreferences.edit().putString("FormTwelve",sharedPreferences.getString("ID","")+ans1+ans2+ans3+ans4+ans5+ans6+ans7+ans8+ans9+ans10+ans11+ans12+ans13+currentDateandTime+currentLocation.getLongitude()+""+currentLocation.getLongitude()+"").apply();
