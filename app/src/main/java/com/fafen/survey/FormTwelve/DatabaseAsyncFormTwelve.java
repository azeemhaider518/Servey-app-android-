...
public class DatabaseAsyncFormTwelve extends AsyncTask<String,Void ,String> {
    ...
    public DatabaseAsyncFormTwelve(Context context)
    {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            String ans12 = params[12];
            String ans13 = params[13];
            String date = params[14];
            String lati = params[15];
            String longi = params[16];
