...
public class DatabaseAsync extends AsyncTask<String,Void ,String> {
    ...
    protected String doInBackground(String... params)
    {
        ...
        try
        {
            ...
            String ans6 = params[5];
            String ans7 = params[5];
            String ans8 = params[5];
    ...
    protected void onPostExecute(String result) {
        ...
        returnIntent.putExtra("result","Done Form thirteen");
