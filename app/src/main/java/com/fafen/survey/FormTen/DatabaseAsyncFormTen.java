...
public class DatabaseAsyncFormTen extends AsyncTask<String,Void ,String> {
    ...
    public DatabaseAsyncFormTen(Context context)
    {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            String lati = params[10];
            String longi = params[11];
