...
public class DatabaseAsyncFormFourteen extends AsyncTask<String,Void ,String> {
    ...
    public DatabaseAsyncFormFourteen(Context context)
    {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            Log.e("TAG",id+ans1+ans2+ans3+ans4+ans5+ans6+ans7+ans8+ans9+lati+longi);
    ...
    protected void onPostExecute(String result) {
        ...
        returnIntent.putExtra("result","Done Form Four");
