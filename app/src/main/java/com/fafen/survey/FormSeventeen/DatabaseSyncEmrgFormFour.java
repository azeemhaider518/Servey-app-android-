...
public class DatabaseSyncEmrgFormFour extends AsyncTask<String,Void ,String> {
    ...
    public DatabaseSyncEmrgFormFour(Context context)
    {
    ...
    protected String doInBackground(String... params)
    {
        ...
        try
        {
            ...
            String date = params[13];
            String lati = params[14];
            String longi = params[15];
