...
public class DatabaseAsyncFormFive extends AsyncTask<String,Void ,String> {
    ...
    public DatabaseAsyncFormFive(Context context)
    {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            String longi = params[8];
            URL url = new URL(ServerURL);

            System.out.println(id+":"+ans1+":"+ans2+":"+ans3+":"+ans4+":"+ans5+":"+lati+":"+longi);
